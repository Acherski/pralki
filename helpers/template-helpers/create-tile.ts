import { WashingMachineWithUuid } from "../../model/washing-machine.model.js";
...
export function createWashingMachineTile(
  value: WashingMachineWithUuid,
  isSelected: boolean
) {
  return `
      ...
      <div class="tile">
        <div class="tile__data-and-image">
          ...
          <div class="tile__data">
            ...
            <span class="tile__instalment" style="visibility: ${
              value.instalment.availability ? "visible" : "hidden"
            }">
        ...
        <div class="btn-container">
          <button id="${value.uuid}" class="${
            isSelected ? "btn-primary--activated" : "btn-primary"
            }">
